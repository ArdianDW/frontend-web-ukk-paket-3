...
export default function EditBarangPage() {
  ...
  useEffect(() => {
    ...
    if (id) {
      axios.get(`http://127.0.0.1:8000/api/inventaris/${id}/`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
      .then(response => {
        ...
        form.reset({
          nama: barang.nama,
          jenis: barang.id_jenis.toString(),
          jumlah: barang.jumlah,
          ruang: barang.id_ruang.toString(),
          kondisi: barang.kondisi,
          keterangan: barang.keterangan,
          tanggalRegister: barang.tanggal_register,
          kodeInventaris: barang.kode_inventaris,
        });
      })
  ...
  const onSubmit = (data: FormData) => {
    ...
    axios.put(`http://127.0.0.1:8000/api/inventaris/${id}/`, requestData, {
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
    })
    .then(response => {
      console.log("Data Barang berhasil diperbarui:", response.data);
      toast({
        title: "Sukses",
